...
resultsFolder = 'sandipresults_cnn';
...
cm.Title = 'Confusion Matrix - CNN Model';
cm.RowSummary = 'row-normalized';
cm.ColumnSummary = 'column-normalized';
saveas(gcf, fullfile(resultsFolder, 'confusion_matrix_CNN.png'));
...
writetable(confMatTable, fullfile(resultsFolder, 'confusion_matrix_CNN.csv'), 'WriteRowNames', true);
...
filenameExcel = fullfile(resultsFolder, 'CNN_Performance_Metrics.xlsx');
