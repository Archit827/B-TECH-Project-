...
resultsFolder = 'sandipresults_cnn_dataaug';
...
cm.Title = 'Confusion Matrix - CNN Model with Data Augmentation';
cm.RowSummary = 'row-normalized';
cm.ColumnSummary = 'column-normalized';
saveas(gcf, fullfile(resultsFolder, 'confusion_matrix_CNN_DataAug.png'));
...
writetable(confMatTable, fullfile(resultsFolder, 'confusion_matrix_CNN_DataAug.csv'), 'WriteRowNames', true);
...
filenameExcel = fullfile(resultsFolder, 'CNN_DataAug_Performance_Metrics.xlsx');
