...
resultsFolder = 'sandipresults_lstm';
...
cm.Title = 'Confusion Matrix - LSTM Model';
cm.RowSummary = 'row-normalized';
cm.ColumnSummary = 'column-normalized';
saveas(gcf, fullfile(resultsFolder, 'confusion_matrix_LSTM.png'));
...
writetable(confMatTable, fullfile(resultsFolder, 'confusion_matrix_LSTM.csv'), 'WriteRowNames', true);
...
filenameExcel = fullfile(resultsFolder, 'LSTM_Performance_Metrics.xlsx');
